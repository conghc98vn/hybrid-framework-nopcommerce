...
public class HomePageUI {
	...
	public static final String DYNAMIC_COLUMN_INDEX_BY_COLUMN_NAME = "xpath=//th[text()='%s']/preceding::th";
	public static final String DYNAMIC_TEXTBOX_BY_ROW_INDEX_AND_COLUMN_INDEX = "xpath=//tr[%s]/td[%s]/input";
	public static final String DYNAMIC_SELECT_COUNTRY_BY_ROW_INDEX = "xpath=//tr[%s]/td[4]//select";
}
